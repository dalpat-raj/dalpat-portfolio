...
const Contact = () => {
  return (
    <section className="contact__section container" id="contact">
        <h2 data-heading="Get in touch" className="section__title__heading">Contact Me</h2>
        ...
        <div className="contact__container__grid">
            ...
            <div className="contact__content">
                <form className="contact__info">
                    <div className="input___container focus">
                    ...
                    <div className="input___container textarea">
                        <textarea name="" id="" className='input' />
                        <label htmlFor="">Message</label>
                        <span>Message</span>
                    </div>
                    <button type='submit' className='button'><i className="uil uil-navigator button__info"></i>Send Message</button>
                </form>
            </div>
        </div>
    </section>
